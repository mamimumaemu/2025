...
questions = [
    {
        ...
        "options": [
            ...
            "C. 출처와 근거가 없으므로 다른 자료를 확인하고 비교 후 판단한다",
            "D. 광고 디자인과 전문성 있는 문구 때문에 신뢰할 수 있다"
        ],
        "answer": "C. 출처와 근거가 없으므로 다른 자료를 확인하고 비교 후 판단한다",
    ...
    },
    {
        ...
        "options": [
            "A. 유명인이 추천했으므로 제품 효과가 입증되었다고 볼 수 있다",
            "B. 현실적으로 가능성이 낮으므로 근거와 추가 자료를 검토 후 판단한다",
            "C. 광고 이미지가 전문적이므로 신뢰 가능하다",
            "D. 광고 문구가 설득력 있으므로 효과를 기대할 수 있다"
        ],
        "answer": "B. 현실적으로 가능성이 낮으므로 근거와 추가 자료를 검토 후 판단한다",
